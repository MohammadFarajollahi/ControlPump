...
public static anywheresoftware.b4a.randomaccessfile.AsyncStreams _v6 = null;
...
public anywheresoftware.b4a.objects.LabelWrapper _vv2 = null;
...
public anywheresoftware.b4a.objects.drawable.BitmapDrawable _vv3 = null;
public b4a.example.starter _vv4 = null;
...
//C
this.state = 1;
 //BA.debugLineNum = 56;BA.debugLine="Dim rp As RuntimePermissions";
_rp = new anywheresoftware.b4a.objects.RuntimePermissions();
 //BA.debugLineNum = 57;BA.debugLine="rp.CheckAndRequest(\"android.permission.BLUETOOTH_";
...
//C
this.state = 4;
 //BA.debugLineNum = 61;BA.debugLine="ToastMessageShow(\"دسترسی داده نشد!\", True)";
...
this.state = -1;
;
 //BA.debugLineNum = 63;BA.debugLine="Activity.LoadLayout(\"Main\")   ' توی دیزاین، دکمه‌";
parent.mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 64;BA.debugLine="Serial1.Initialize(\"Serial1\")";
parent._v5.Initialize("Serial1");
 //BA.debugLineNum = 66;BA.debugLine="DeviceList.Initialize";
parent._v7.Initialize();
...
int _i = 0;
String _line = "";
 //BA.debugLineNum = 135;BA.debugLine="Sub AStream_NewData (Buffer() As Byte)";
 //BA.debugLineNum = 137;BA.debugLine="Dim msg As String = BytesToString(Buffer, 0, Buff";
_msg = anywheresoftware.b4a.keywords.Common.BytesToString(_buffer,(int) (0),_buffer.length,"UTF8");
 //BA.debugLineNum = 138;BA.debugLine="BufferString = BufferString & msg   ' تکه جدید رو";
mostCurrent._v0 = mostCurrent._v0+_msg;
 //BA.debugLineNum = 140;BA.debugLine="If BufferString.Contains(Chr(10)) Then";
if (mostCurrent._v0.contains(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10))))) { 
 //BA.debugLineNum = 141;BA.debugLine="EditText14.Text =BufferString";
mostCurrent._edittext14.setText(BA.ObjectToCharSequence(mostCurrent._v0));
 //BA.debugLineNum = 142;BA.debugLine="Dim lines() As String = Regex.Split(Chr(10), Buf";
_lines = anywheresoftware.b4a.keywords.Common.Regex.Split(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10))),mostCurrent._v0);
 //BA.debugLineNum = 143;BA.debugLine="For i = 0 To lines.Length - 1";
{
final int step6 = 1;
final int limit6 = (int) (_lines.length-1);
_i = (int) (0) ;
for (;_i <= limit6 ;_i = _i + step6 ) {
 //BA.debugLineNum = 144;BA.debugLine="Dim line As String = lines(i).Trim";
_line = _lines[_i].trim();
 //BA.debugLineNum = 145;BA.debugLine="If line.Length > 0 Then ParseEEPROMData(line)";
if (_line.length()>0) { 
_vv1(_line);};
 }
};
 //BA.debugLineNum = 147;BA.debugLine="BufferString = lines(lines.Length - 1)";
mostCurrent._v0 = _lines[(int) (_lines.length-1)];
 //BA.debugLineNum = 148;BA.debugLine="BufferString = \"\"";
mostCurrent._v0 = "";
 };
...
String _name = "";
String _mac = "";
 //BA.debugLineNum = 86;BA.debugLine="Sub btnSearch_Click";
...
String _ss = "";
byte[] _data = null;
 //BA.debugLineNum = 128;BA.debugLine="Sub btnSend_Click";
 //BA.debugLineNum = 129;BA.debugLine="Dim ss As String";
_ss = "";
 //BA.debugLineNum = 130;BA.debugLine="ss= \"GetEeprom\"";
_ss = "GetEeprom";
 //BA.debugLineNum = 131;BA.debugLine="Dim data() As Byte = ss.GetBytes(\"UTF8\")'txtData.";
...
byte[] _data = null;
 ...
 //BA.debugLineNum = 78;BA.debugLine="Dim ss As String";
_ss = "";
 //BA.debugLineNum = 79;BA.debugLine="ss= \"eeprom/\" & EditText1.Text & \"/\" & EditText2.";
_ss = "eeprom/"+mostCurrent._edittext1.getText()+"/"+mostCurrent._edittext2.getText()+"/"+mostCurrent._edittext3.getText()+"/"+mostCurrent._edittext4.getText()+"/"+mostCurrent._edittext5.getText()+"/"+mostCurrent._edittext6.getText()+"/"+mostCurrent._edittext7.getText()+"/"+BA.NumberToString(((double)(Double.parseDouble(mostCurrent._edittext8.getText()))*10))+"/"+BA.NumberToString(((double)(Double.parseDouble(mostCurrent._edittext9.getText()))*10))+"/"+BA.NumberToString(((double)(Double.parseDouble(mostCurrent._edittext10.getText()))*10))+"/"+mostCurrent._edittext11.getText()+"/"+mostCurrent._edittext12.getText()+"/"+mostCurrent._edittext13.getText();
 //BA.debugLineNum = 80;BA.debugLine="Dim data() As Byte = ss.GetBytes(\"UTF8\")'txtData.";
_data = _ss.getBytes("UTF8");
 //BA.debugLineNum = 81;BA.debugLine="AStream.Write(data)";
_v6.Write(_data);
...
String _ss = "";
byte[] _data = null;
 //BA.debugLineNum = 189;BA.debugLine="Private Sub Button2_Click";
 //BA.debugLineNum = 190;BA.debugLine="Dim ss As String";
_ss = "";
 //BA.debugLineNum = 191;BA.debugLine="ss= \"GetEeprom\"";
_ss = "GetEeprom";
 //BA.debugLineNum = 192;BA.debugLine="Dim data() As Byte = ss.GetBytes(\"UTF8\")'txtData.";
_data = _ss.getBytes("UTF8");
 //BA.debugLineNum = 193;BA.debugLine="AStream.Write(data)";
_v6.Write(_data);
...
String _ss = "";
byte[] _data = null;
 //BA.debugLineNum = 196;BA.debugLine="Private Sub Button3_Click";
 //BA.debugLineNum = 197;BA.debugLine="Dim ss As String";
_ss = "";
 //BA.debugLineNum = 198;BA.debugLine="ss= \"ResetDevice\"";
_ss = "ResetDevice";
 //BA.debugLineNum = 199;BA.debugLine="Dim data() As Byte = ss.GetBytes(\"UTF8\")'txtData.";
_data = _ss.getBytes("UTF8");
 //BA.debugLineNum = 200;BA.debugLine="AStream.Write(data)";
_v6.Write(_data);
...
mostCurrent._vv2 = new anywheresoftware.b4a.objects.LabelWrapper();
...
mostCurrent._vv3 = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 53;BA.debugLine="End Sub";
return "";
}
public static String  _lstdevices_itemclick(int _position,Object _value) throws Exception{
String _macaddress = "";
 //BA.debugLineNum = 106;BA.debugLine="Sub lstDevices_ItemClick (Position As Int, Value A";
 //BA.debugLineNum = 107;BA.debugLine="Dim MacAddress As String = Value";
_macaddress = BA.ObjectToString(_value);
 //BA.debugLineNum = 108;BA.debugLine="Serial1.Connect(MacAddress)   ' اتصال به ماژول ان";
_v5.Connect(processBA,_macaddress);
 //BA.debugLineNum = 109;BA.debugLine="ToastMessageShow(\"در حال اتصال...\", False)";
...
_v6 = new anywheresoftware.b4a.randomaccessfile.AsyncStreams();
...
String _ss = "";
byte[] _data = null;
 //BA.debugLineNum = 112;BA.debugLine="Sub Serial1_Connected (Success As Boolean)";
 //BA.debugLineNum = 113;BA.debugLine="If Success Then";
if (_success) { 
 //BA.debugLineNum = 114;BA.debugLine="ToastMessageShow(\"اتصال موفق!\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("اتصال موفق!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 115;BA.debugLine="AStream.Initialize(Serial1.InputStream, Serial1.";
_v6.Initialize(processBA,_v5.getInputStream(),_v5.getOutputStream(),"AStream");
 //BA.debugLineNum = 116;BA.debugLine="bmp.Initialize(LoadBitmap(File.DirAssets, \"conne";
mostCurrent._vv3.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"connected_500px.png").getObject()));
 //BA.debugLineNum = 117;BA.debugLine="ImageView1.Background = bmp";
mostCurrent._imageview1.setBackground((android.graphics.drawable.Drawable)(mostCurrent._vv3.getObject()));
 //BA.debugLineNum = 118;BA.debugLine="Dim ss As String";
_ss = "";
 //BA.debugLineNum = 119;BA.debugLine="ss= \"GetEeprom\"";
_ss = "GetEeprom";
 //BA.debugLineNum = 120;BA.debugLine="Dim data() As Byte = ss.GetBytes(\"UTF8\")'txtData";
_data = _ss.getBytes("UTF8");
 //BA.debugLineNum = 121;BA.debugLine="AStream.Write(data)";
_v6.Write(_data);
 }else {
 //BA.debugLineNum = 123;BA.debugLine="ToastMessageShow(\"اتصال ناموفق!\", True)";
