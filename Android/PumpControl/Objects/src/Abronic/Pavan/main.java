...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "Abronic.Pavan", "Abronic.Pavan.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "Abronic.Pavan", "Abronic.Pavan.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "Abronic.Pavan.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public anywheresoftware.b4a.objects.LabelWrapper _lblreceived = null;
public anywheresoftware.b4a.objects.EditTextWrapper _txtdata = null;
...
public Abronic.Pavan.mainscreen _mainscreen = null;
...
public ResumableSub_Activity_Create(Abronic.Pavan.main parent,boolean _firsttime) {
this.parent = parent;
this._firsttime = _firsttime;
}
Abronic.Pavan.main parent;
boolean _firsttime;
...
_rp = new anywheresoftware.b4a.objects.RuntimePermissions();
 //BA.debugLineNum = 59;BA.debugLine="rp.CheckAndRequest(\"android.permission.BLUETOOTH_";
_rp.CheckAndRequest(processBA,"android.permission.BLUETOOTH_CONNECT");
 //BA.debugLineNum = 60;BA.debugLine="rp.CheckAndRequest(rp.PERMISSION_ACCESS_FINE_LOCA";
...
;
 //BA.debugLineNum = 62;BA.debugLine="If Result = False Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 63;BA.debugLine="ToastMessageShow(\"دسترسی داده نشد!\", True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("دسترسی داده نشد!"),anywheresoftware.b4a.keywords.Common.True);
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 65;BA.debugLine="StartActivity(MainScreen)";
...
parent.mostCurrent._activity.Finish();
 //BA.debugLineNum = 67;BA.debugLine="Activity.LoadLayout(\"Main\")   ' توی دیزاین، دکمه‌";
parent.mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 68;BA.debugLine="Serial1.Initialize(\"Serial1\")";
parent._serial1.Initialize("Serial1");
 //BA.debugLineNum = 70;BA.debugLine="DeviceList.Initialize";
parent._devicelist.Initialize();
...
int _i = 0;
String _line = "";
 //BA.debugLineNum = 139;BA.debugLine="Sub AStream_NewData (Buffer() As Byte)";
 //BA.debugLineNum = 141;BA.debugLine="Dim msg As String = BytesToString(Buffer, 0, Buff";
_msg = anywheresoftware.b4a.keywords.Common.BytesToString(_buffer,(int) (0),_buffer.length,"UTF8");
 //BA.debugLineNum = 142;BA.debugLine="BufferString = BufferString & msg   ' تکه جدید رو";
mostCurrent._bufferstring = mostCurrent._bufferstring+_msg;
 //BA.debugLineNum = 144;BA.debugLine="If BufferString.Contains(Chr(10)) Then";
if (mostCurrent._bufferstring.contains(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10))))) { 
 //BA.debugLineNum = 145;BA.debugLine="EditText14.Text =BufferString";
mostCurrent._edittext14.setText(BA.ObjectToCharSequence(mostCurrent._bufferstring));
 //BA.debugLineNum = 146;BA.debugLine="Dim lines() As String = Regex.Split(Chr(10), Buf";
_lines = anywheresoftware.b4a.keywords.Common.Regex.Split(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10))),mostCurrent._bufferstring);
 //BA.debugLineNum = 147;BA.debugLine="For i = 0 To lines.Length - 1";
{
final int step6 = 1;
final int limit6 = (int) (_lines.length-1);
_i = (int) (0) ;
for (;_i <= limit6 ;_i = _i + step6 ) {
 //BA.debugLineNum = 148;BA.debugLine="Dim line As String = lines(i).Trim";
_line = _lines[_i].trim();
 //BA.debugLineNum = 149;BA.debugLine="If line.Length > 0 Then ParseEEPROMData(line)";
if (_line.length()>0) { 
_parseeepromdata(_line);};
 }
};
 //BA.debugLineNum = 151;BA.debugLine="BufferString = lines(lines.Length - 1)";
mostCurrent._bufferstring = _lines[(int) (_lines.length-1)];
 //BA.debugLineNum = 152;BA.debugLine="BufferString = \"\"";
...
String _name = "";
String _mac = "";
 //BA.debugLineNum = 90;BA.debugLine="Sub btnSearch_Click";
 //BA.debugLineNum = 91;BA.debugLine="If Serial1.IsEnabled = False Then";
if (_serial1.IsEnabled()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 92;BA.debugLine="ToastMessageShow(\"Bluetooth روشن نیست!\", True)";
...
if (true) return "";
 ...
 //BA.debugLineNum = 96;BA.debugLine="Dim PairedDevices As Map";
_paireddevices = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 97;BA.debugLine="PairedDevices = Serial1.GetPairedDevices";
_paireddevices = _serial1.GetPairedDevices();
 //BA.debugLineNum = 98;BA.debugLine="lstDevices.Clear";
mostCurrent._lstdevices.Clear();
 //BA.debugLineNum = 100;BA.debugLine="For i = 0 To PairedDevices.Size - 1";
{
final int step8 = 1;
final int limit8 = (int) (_paireddevices.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit8 ;_i = _i + step8 ) {
 //BA.debugLineNum = 101;BA.debugLine="Dim name As String = PairedDevices.GetKeyAt(i)";
_name = BA.ObjectToString(_paireddevices.GetKeyAt(_i));
 //BA.debugLineNum = 102;BA.debugLine="Dim mac As String = PairedDevices.GetValueAt(i)";
_mac = BA.ObjectToString(_paireddevices.GetValueAt(_i));
 //BA.debugLineNum = 103;BA.debugLine="lstDevices.AddSingleLine2(name, mac)";
mostCurrent._lstdevices.AddSingleLine2(BA.ObjectToCharSequence(_name),(Object)(_mac));
 }
};
 //BA.debugLineNum = 106;BA.debugLine="ToastMessageShow(\"لیست دستگاه‌ها آماده است\", Fals";
...
String _ss = "";
byte[] _data = null;
 //BA.debugLineNum = 132;BA.debugLine="Sub btnSend_Click";
 //BA.debugLineNum = 133;BA.debugLine="Dim ss As String";
_ss = "";
 //BA.debugLineNum = 134;BA.debugLine="ss= \"GetEeprom\"";
_ss = "GetEeprom";
 //BA.debugLineNum = 135;BA.debugLine="Dim data() As Byte = ss.GetBytes(\"UTF8\")'txtData.";
_data = _ss.getBytes("UTF8");
 //BA.debugLineNum = 136;BA.debugLine="AStream.Write(data)";
...
String _ss = "";
byte[] _data = null;
 //BA.debugLineNum = 193;BA.debugLine="Private Sub Button2_Click";
 //BA.debugLineNum = 194;BA.debugLine="Dim ss As String";
_ss = "";
 //BA.debugLineNum = 195;BA.debugLine="ss= \"GetEeprom\"";
_ss = "GetEeprom";
...
String _ss = "";
byte[] _data = null;
 //BA.debugLineNum = 200;BA.debugLine="Private Sub Button3_Click";
 //BA.debugLineNum = 201;BA.debugLine="Dim ss As String";
_ss = "";
 //BA.debugLineNum = 202;BA.debugLine="ss= \"ResetDevice\"";
_ss = "ResetDevice";
 //BA.debugLineNum = 203;BA.debugLine="Dim data() As Byte = ss.GetBytes(\"UTF8\")'txtData.";
_data = _ss.getBytes("UTF8");
 //BA.debugLineNum = 204;BA.debugLine="AStream.Write(data)";
_astream.Write(_data);
 //BA.debugLineNum = 205;BA.debugLine="End Sub";
return "";
}
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 207;BA.debugLine="Private Sub Button4_Click";
 //BA.debugLineNum = 208;BA.debugLine="pPopup.Visible=True";
mostCurrent._ppopup.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 209;BA.debugLine="pPopup.Left = (100%x - pPopup.Width) / 2";
mostCurrent._ppopup.setLeft((int) ((anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._ppopup.getWidth())/(double)2));
 //BA.debugLineNum = 210;BA.debugLine="pPopup.Top  = (100%y - pPopup.Height) / 2";
mostCurrent._ppopup.setTop((int) ((anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._ppopup.getHeight())/(double)2));
 //BA.debugLineNum = 211;BA.debugLine="pPopup.Visible = True";
mostCurrent._ppopup.setVisible(anywheresoftware.b4a.keywords.Common.True);
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Dim BufferString As String = \"\"   ' <-- اینجا معر";
mostCurrent._bufferstring = "";
...
mostCurrent._btnsearch = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Private lstDevices As ListView";
mostCurrent._lstdevices = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Private btnSend As Button";
mostCurrent._btnsend = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Private lblReceived As Label";
mostCurrent._lblreceived = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Private txtData As EditText";
mostCurrent._txtdata = new anywheresoftware.b4a.objects.EditTextWrapper();
...
mostCurrent._button2 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 45;BA.debugLine="Private Label16 As Label";
mostCurrent._label16 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 46;BA.debugLine="Private Label17 As Label";
mostCurrent._label17 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 47;BA.debugLine="Private Label20 As Label";
mostCurrent._label20 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 48;BA.debugLine="Private Label34 As Label";
mostCurrent._label34 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 49;BA.debugLine="Private Label35 As Label";
...
mostCurrent._imageview1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 52;BA.debugLine="Dim bmp As BitmapDrawable";
mostCurrent._bmp = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 53;BA.debugLine="Private Button4 As Button";
mostCurrent._button4 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 54;BA.debugLine="Private pPopup As Panel";
...
String _macaddress = "";
 //BA.debugLineNum = 110;BA.debugLine="Sub lstDevices_ItemClick (Position As Int, Value A";
 //BA.debugLineNum = 111;BA.debugLine="Dim MacAddress As String = Value";
_macaddress = BA.ObjectToString(_value);
 //BA.debugLineNum = 112;BA.debugLine="Serial1.Connect(MacAddress)   ' اتصال به ماژول ان";
_serial1.Connect(processBA,_macaddress);
 //BA.debugLineNum = 113;BA.debugLine="ToastMessageShow(\"در حال اتصال...\", False)";
...
String[] _parts = null;
 //BA.debugLineNum = 156;BA.debugLine="Sub ParseEEPROMData(Data As String)";
 //BA.debugLineNum = 158;BA.debugLine="If Data.StartsWith(\"eeprom/\") = True Then";
if (_data.startsWith("eeprom/")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 159;BA.debugLine="Dim parts() As String = Regex.Split(\"/\", Data)";
_parts = anywheresoftware.b4a.keywords.Common.Regex.Split("/",_data);
 //BA.debugLineNum = 160;BA.debugLine="If parts.Length == 14 Then";
if (_parts.length==14) { 
 //BA.debugLineNum = 161;BA.debugLine="EditText1.Text = parts(1)";
mostCurrent._edittext1.setText(BA.ObjectToCharSequence(_parts[(int) (1)]));
 //BA.debugLineNum = 162;BA.debugLine="EditText2.Text = parts(2)";
mostCurrent._edittext2.setText(BA.ObjectToCharSequence(_parts[(int) (2)]));
 //BA.debugLineNum = 163;BA.debugLine="EditText3.Text = parts(3)";
mostCurrent._edittext3.setText(BA.ObjectToCharSequence(_parts[(int) (3)]));
 //BA.debugLineNum = 164;BA.debugLine="EditText4.Text = parts(4)";
mostCurrent._edittext4.setText(BA.ObjectToCharSequence(_parts[(int) (4)]));
 //BA.debugLineNum = 165;BA.debugLine="EditText5.Text = parts(5)";
mostCurrent._edittext5.setText(BA.ObjectToCharSequence(_parts[(int) (5)]));
 //BA.debugLineNum = 166;BA.debugLine="EditText6.Text = parts(6)";
mostCurrent._edittext6.setText(BA.ObjectToCharSequence(_parts[(int) (6)]));
 //BA.debugLineNum = 167;BA.debugLine="EditText7.Text = parts(7)";
mostCurrent._edittext7.setText(BA.ObjectToCharSequence(_parts[(int) (7)]));
 //BA.debugLineNum = 168;BA.debugLine="EditText8.Text = parts(8) / 10";
mostCurrent._edittext8.setText(BA.ObjectToCharSequence((double)(Double.parseDouble(_parts[(int) (8)]))/(double)10));
 //BA.debugLineNum = 169;BA.debugLine="EditText9.Text = parts(9) / 10";
mostCurrent._edittext9.setText(BA.ObjectToCharSequence((double)(Double.parseDouble(_parts[(int) (9)]))/(double)10));
 //BA.debugLineNum = 170;BA.debugLine="EditText10.Text = parts(10) / 10";
mostCurrent._edittext10.setText(BA.ObjectToCharSequence((double)(Double.parseDouble(_parts[(int) (10)]))/(double)10));
 //BA.debugLineNum = 171;BA.debugLine="EditText11.Text = parts(11)";
mostCurrent._edittext11.setText(BA.ObjectToCharSequence(_parts[(int) (11)]));
 //BA.debugLineNum = 172;BA.debugLine="EditText12.Text = parts(12)";
mostCurrent._edittext12.setText(BA.ObjectToCharSequence(_parts[(int) (12)]));
 //BA.debugLineNum = 173;BA.debugLine="EditText13.Text = parts(13)";
mostCurrent._edittext13.setText(BA.ObjectToCharSequence(_parts[(int) (13)]));
 };
 };
 //BA.debugLineNum = 177;BA.debugLine="If Data.StartsWith(\"value/\") = True Then";
if (_data.startsWith("value/")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 178;BA.debugLine="Dim parts() As String = Regex.Split(\"/\", Data)";
_parts = anywheresoftware.b4a.keywords.Common.Regex.Split("/",_data);
 //BA.debugLineNum = 179;BA.debugLine="If parts.Length == 6 Then";
if (_parts.length==6) { 
 //BA.debugLineNum = 180;BA.debugLine="Label20.Text = parts(1) ' ولتاژ پمپ";
mostCurrent._label20.setText(BA.ObjectToCharSequence(_parts[(int) (1)]));
 //BA.debugLineNum = 181;BA.debugLine="Label16.Text = parts(2) ' جریان پمپ";
mostCurrent._label16.setText(BA.ObjectToCharSequence(_parts[(int) (2)]));
 //BA.debugLineNum = 182;BA.debugLine="Label17.Text = parts(3)  ' فشار پمپ";
mostCurrent._label17.setText(BA.ObjectToCharSequence(_parts[(int) (3)]));
 //BA.debugLineNum = 183;BA.debugLine="If parts(4) = 1 Then Label34.Text = \"پمپ روشن\"";
if ((_parts[(int) (4)]).equals(BA.NumberToString(1))) { 
mostCurrent._label34.setText(BA.ObjectToCharSequence("پمپ روشن"));};
 //BA.debugLineNum = 184;BA.debugLine="If parts(4) = 0 Then Label34.Text = \"پمپ خاموش\"";
if ((_parts[(int) (4)]).equals(BA.NumberToString(0))) { 
mostCurrent._label34.setText(BA.ObjectToCharSequence("پمپ خاموش"));};
 //BA.debugLineNum = 186;BA.debugLine="If parts(5) = 0 Then Label35.Text = \"پمپ عادی\"";
if ((_parts[(int) (5)]).equals(BA.NumberToString(0))) { 
mostCurrent._label35.setText(BA.ObjectToCharSequence("پمپ عادی"));};
 //BA.debugLineNum = 187;BA.debugLine="If parts(5) >= 1 Then Label35.Text = \"مشکل هوا";
if ((double)(Double.parseDouble(_parts[(int) (5)]))>=1) { 
mostCurrent._label35.setText(BA.ObjectToCharSequence("مشکل هوا کشی"));};
 };
 };
...
_serial1 = new anywheresoftware.b4a.objects.Serial();
 //BA.debugLineNum = 17;BA.debugLine="Dim AStream As AsyncStreams";
_astream = new anywheresoftware.b4a.randomaccessfile.AsyncStreams();
 //BA.debugLineNum = 18;BA.debugLine="Dim DeviceList As List";
...
if (_success) { 
 //BA.debugLineNum = 118;BA.debugLine="ToastMessageShow(\"اتصال موفق!\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("اتصال موفق!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 119;BA.debugLine="AStream.Initialize(Serial1.InputStream, Serial1.";
_astream.Initialize(processBA,_serial1.getInputStream(),_serial1.getOutputStream(),"AStream");
 //BA.debugLineNum = 120;BA.debugLine="bmp.Initialize(LoadBitmap(File.DirAssets, \"conne";
mostCurrent._bmp.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"connected_500px.png").getObject()));
 //BA.debugLineNum = 121;BA.debugLine="ImageView1.Background = bmp";
mostCurrent._imageview1.setBackground((android.graphics.drawable.Drawable)(mostCurrent._bmp.getObject()));
 //BA.debugLineNum = 122;BA.debugLine="Dim ss As String";
_ss = "";
 //BA.debugLineNum = 123;BA.debugLine="ss= \"GetEeprom\"";
_ss = "GetEeprom";
 //BA.debugLineNum = 124;BA.debugLine="Dim data() As Byte = ss.GetBytes(\"UTF8\")'txtData";
_data = _ss.getBytes("UTF8");
 //BA.debugLineNum = 125;BA.debugLine="AStream.Write(data)";
_astream.Write(_data);
 }else {
 //BA.debugLineNum = 127;BA.debugLine="ToastMessageShow(\"اتصال ناموفق!\", True)";
