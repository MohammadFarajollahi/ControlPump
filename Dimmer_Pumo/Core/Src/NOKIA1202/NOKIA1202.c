...
#define NOKIA1202_RESET_Pin       GPIO_PIN_14
#define NOKIA1202_RESET_GPIO_Port GPIOB
#define NOKIA1202_RESET_Rcc       __HAL_RCC_GPIOB_CLK_ENABLE();

#define NIKIA1202_CS_Pin          GPIO_PIN_15
#define NIKIA1202_CS_GPIO_Port    GPIOB
#define NOKIA1202_CS_Rcc          __HAL_RCC_GPIOB_CLK_ENABLE();

#define NOKIA1202_MOSI_Pin        GPIO_PIN_8
#define NOKIA1202_MOSI_GPIO_Port  GPIOA
#define NOKIA1202_MOSI_Rcc        __HAL_RCC_GPIOA_CLK_ENABLE();
  
#define NOKIA1202_SCK_Pin         GPIO_PIN_9
...
void lcdRow(char r);
void lcdCol(char c);
void LCD_NOKIA1202(char line,char cloumn,char* s);
void xputc(char r);
void lcdSpi(int d);
